...
Run unit tests, all-rank smoke tests and the full release audit before proposing
changes. Preserve command lines, code hashes, compiler details, timing and status.
